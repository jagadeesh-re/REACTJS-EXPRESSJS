...
describe(':::RJSCEQHZ58_TEST_SUITE_1:::Projects Showcase Tests', () => {
  ...
  it(':::RJSCEQHZ58_TEST_6:::When the page is opened, then it should initially consist of an HTML container element with testid attribute value as "loader":::5:::', async () => {
    render(<App />)
