...
describe(':::RJSCPDXAGS_TEST_SUITE_1:::Prime Video Tests', () => {
  it(':::RJSCPDXAGS_TEST_1:::Page should consist of an HTML image element with alt attribute value as "prime video" and src as given prime video image URL:::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCPDXAGS_TEST_3:::Page should consist of "Action Movies" heading with text color as "#ffffff":::5:::', () => {
    render(<App />)
    const headingEl = screen.getByRole('heading', {
      name: /Action Movies/i,
      exact: false,
    ...
    expect(headingEl).toBeInTheDocument()
    expect(headingEl).toHaveStyleRule('color', '#ffffff')
  })
  ...
  it(':::RJSCPDXAGS_TEST_6:::Page should consist of "Comedy Movies" heading with text color as "#ffffff":::5:::', () => {
    render(<App />)
    const headingEl = screen.getByRole('heading', {
      name: /Comedy Movies/i,
      exact: false,
  ...
  it(':::RJSCPDXAGS_TEST_9:::When the next arrow button is clicked in Action Movies Slider, the page should consist of the next HTML image element with alt attribute value as "thumbnail" and src as the value of the key "thumbnailUrl" of the movie item with categoryId as "ACTION" in the "moviesList" provided:::5:::', () => {
    render(<App />)
