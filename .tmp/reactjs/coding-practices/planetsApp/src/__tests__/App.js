...
describe(':::RJSCP4DA5Y_TEST_SUITE_1:::Planets App tests', () => {
  it(':::RJSCP4DA5Y_TEST_1:::Page should consist of an HTML container element with data-testid as "planets":::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCP4DA5Y_TEST_3:::Page should consist of HTML image elements with alt attribute value as "planet {planetName}" and src value as "imageUrl" of the planet item in the "planetsList":::5:::', async () => {
    render(<App />)
  ...
  it(':::RJSCP4DA5Y_TEST_7:::When the next arrow button is clicked, then the page should consist of HTML image element with alt attribute value as "planet {planetName}" and src value as "imageUrl" of the next planet item in the "planetsList":::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCP4DA5Y_TEST_13:::The image URL provided should be applied as the background image for the styled component with data-testid as "planets":::5:::', () => {
    render(<App />)
    expect(screen.getByTestId('planets')).toHaveStyle(
      `background-image: url(${backgroundImage})`,
    )
  })

  it(':::RJSCP4DA5Y_TEST_14:::The HTML main heading element with text content as "PLANETS" should consist of "font-family" value as "Roboto":::5:::', () => {
    render(<App />)
    expect(
      screen.getByRole('heading', {
        name: /PLANETS/i,
    ...
    ).toHaveStyleRule('font-family', expect.stringContaining('Roboto'))
  })
})
