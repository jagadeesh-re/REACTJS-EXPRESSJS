...
describe(':::RJSCPAYVCK_TEST_SUITE_1:::Debugging Fetch And Routing tests', () => {
  ...
  it(':::RJSCPAYVCK_TEST_5:::When the Home Route is opened, it should initially consist of an HTML container element with testid attribute value as "loader":::5:::', async () => {
    renderWithBrowserRouter()
