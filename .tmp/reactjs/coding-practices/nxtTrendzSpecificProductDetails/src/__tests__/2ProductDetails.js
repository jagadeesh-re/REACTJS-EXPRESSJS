...
describe(':::RJSCP809S4_TEST_SUITE_2:::Product Item Details Route tests', () => {
  ...
  it(':::RJSCP809S4_TEST_8:::When the Product Item Details Route is opened, an HTML container element with testid attribute value as "loader" should be displayed while the HTTP GET request is in progress:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: productDetailsPath})
  ...
  it(':::RJSCP809S4_TEST_18:::When the HTTP GET request in the Product Item Details route is successful, an HTML button element with testid attribute value as "plus":::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: productDetailsPath})
    expect(
      await screen.findByRole('heading', {
  ...
  it(':::RJSCP809S4_TEST_19:::When the HTTP GET request in the Product Item Details route is successful, an HTML button element with testid attribute value as "minus":::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: productDetailsPath})
    expect(
      await screen.findByRole('heading', {
  ...
  it(':::RJSCP809S4_TEST_22:::When the HTML button with testid "plus" is clicked, the quantity should be incremented by one:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: productDetailsPath})
    expect(
      await screen.findByRole('heading', {
  ...
  it(':::RJSCP809S4_TEST_23:::When the HTML button with testid "minus" is clicked, the quantity should be decremented by one:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: productDetailsPath})
    expect(
      await screen.findByRole('heading', {
  ...
  it(':::RJSCP809S4_TEST_24:::When the HTML button with testid "minus" is clicked, the quantity should not be decremented below one:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter(<App />, {route: productDetailsPath})
    expect(
      await screen.findByRole('heading', {
