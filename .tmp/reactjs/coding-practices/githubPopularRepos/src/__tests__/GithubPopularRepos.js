...
describe(':::RJSCPYR39R_TEST_SUITE_1:::Github popular repos App Component Test Cases', () => {
  ...
  it(':::RJSCPYR39R_TEST_8:::When the page is opened, an HTML container element with testid attribute value as "loader" should be displayed while the HTTP GET request is in progress:::5:::', async () => {
    render(<GithubPopularRepositoriesApp />)
