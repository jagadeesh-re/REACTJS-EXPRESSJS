...
describe(':::RJSCPN3E00_TEST_SUITE_2:::Home Route Tests', () => {
  it(':::RJSCPN3E00_TEST_16:::Home Route should consist of an HTML image element with alt attribute value as "website logo" and src as the given logo URL:::5:::', () => {
  ...
  it(':::RJSCPN3E00_TEST_23:::Home Route should consist of an HTML image element with alt attribute value as "home" and src as the given Home URL :::5:::', () => {
    renderWithBrowserRouter(<App />)
  ...
  it(':::RJSCPN3E00_TEST_29:::Home Link in the Popup should have "font-family" value as "Roboto":::5:::', () => {
    renderWithBrowserRouter(<App />)
    const btnEl = screen.getByTestId('hamburgerIconButton')
    userEvent.click(btnEl)
    expect(
  ...
  it(':::RJSCPN3E00_TEST_31:::About Link in the Popup should have "font-family" value as "Roboto":::5:::', () => {
    renderWithBrowserRouter(<App />)
    const btnEl = screen.getByTestId('hamburgerIconButton')
    userEvent.click(btnEl)
    expect(
