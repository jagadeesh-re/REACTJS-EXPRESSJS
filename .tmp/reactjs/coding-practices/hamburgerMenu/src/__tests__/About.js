...
describe(':::RJSCPN3E00_TEST_SUITE_1:::About Route Tests', () => {
  it(':::RJSCPN3E00_TEST_1:::About Route should consist of an HTML image element with alt attribute value as "website logo" and src as the given logo URL:::5:::', () => {
  ...
  it(':::RJSCPN3E00_TEST_4:::About Route should consist of an HTML image element with alt attribute value as "about" and src as the given About URL:::5:::', () => {
    renderWithBrowserRouter(<App />)
  ...
  it(':::RJSCPN3E00_TEST_11:::Home Link in the Popup should have "font-family" value as "Roboto":::5:::', () => {
    renderWithBrowserRouter(<App />)
    const btnEl = screen.getByTestId('hamburgerIconButton')
    userEvent.click(btnEl)
    expect(
  ...
  it(':::RJSCPN3E00_TEST_13:::About Link in the Popup should have "font-family" value as "Roboto":::5:::', () => {
    renderWithBrowserRouter(<App />)
    const btnEl = screen.getByTestId('hamburgerIconButton')
    userEvent.click(btnEl)
    expect(
