...
describe(':::RJSCPNE8JJ_TEST_SUITE_2:::Team Matches Route tests', () => {
  beforeAll(() => {
    server.listen()
  })
  afterEach(() => {
  ...
  it(':::RJSCPNE8JJ_TEST_11:::Page should consist of at least two HTML list items and the recent matches list received in the response should be rendered using a unique key as a prop for each recent match:::5:::', async () => {
  ...
  it(':::RJSCPNE8JJ_TEST_12:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of an HTML paragraph element with text content equal to the "umpires" in latest match details received in the response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
  ...
  it(':::RJSCPNE8JJ_TEST_13:::When the Team Matches Route is opened, it should initially contain an HTML container element with testid attribute value as "loader":::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    await waitForElementToBeRemoved(() => screen.queryByTestId('loader'))
  })

  it(':::RJSCPNE8JJ_TEST_14:::When the Team Matches Route is opened, an HTTP GET request should be made to the given teamMatchesApiUrl to get recent matches based on the team selected:::5:::', async () => {
  ...
  it(':::RJSCPNE8JJ_TEST_15:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of an HTML image element with alt as "team banner" and src value equal to the "team_banner_url" received in the response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
  ...
  it(':::RJSCPNE8JJ_TEST_16:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of an HTML paragraph element with text content equal to the "competing_team" in latest match details received in the response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    const {latest_match_details} = recentMatchesResponse
  ...
  it(':::RJSCPNE8JJ_TEST_17:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of an HTML paragraph element with text content equal to the "date" in latest match details received in the response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    const {latest_match_details} = recentMatchesResponse
  ...
  it(':::RJSCPNE8JJ_TEST_18:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of an HTML paragraph element with text content equal to the "venue" in latest match details received in the response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    const {latest_match_details} = recentMatchesResponse
  ...
  it(':::RJSCPNE8JJ_TEST_19:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of an HTML paragraph element with text content equal to the "result" in latest match details received in the response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    const {latest_match_details} = recentMatchesResponse
  ...
  it(':::RJSCPNE8JJ_TEST_20:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of HTML image element with alt value as "latest match {competing_team}" and src value equal to the "competing_team_logo" in latest match details received in response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    const {latest_match_details} = recentMatchesResponse
  ...
  it(':::RJSCPNE8JJ_TEST_21:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of HTML paragraph element with text content equal to the "first_innings" in latest match details received in the response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    const {latest_match_details} = recentMatchesResponse
  ...
  it(':::RJSCPNE8JJ_TEST_22:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of an HTML paragraph element with text content equal to the "second_innings" in latest match details received in the response :::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    const {latest_match_details} = recentMatchesResponse
  ...
  it(':::RJSCPNE8JJ_TEST_23:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of an HTML paragraph element with text content equal to the "man_of_the_match" in latest match details received in the response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    const {latest_match_details} = recentMatchesResponse
  ...
  it(':::RJSCPNE8JJ_TEST_24:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of HTML image elements with alt as "competing team {competing_team}" and src value equal to the "competing_team_logo" in recent matches received in response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
  ...
  it(':::RJSCPNE8JJ_TEST_25:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of HTML paragraph elements with text content equal to the "competing_team" in recent matches received in the response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    const {recent_matches} = recentMatchesResponse
  ...
  it(':::RJSCPNE8JJ_TEST_26:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of HTML paragraph elements with text content equal to the "result" in recent matches received in the response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    const {recent_matches} = recentMatchesResponse
  ...
  it(':::RJSCPNE8JJ_TEST_27:::When the HTTP GET request made in Team Matches Route is successful, then the page should consist of HTML paragraph elements with text content equal to the "match_status" in recent matches received in the response:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    const {recent_matches} = recentMatchesResponse
  ...
  it(':::RJSCPNE8JJ_TEST_28:::When "/team-matches/:id" is provided in the URL, then the page should be navigated to the Team Matches Route and consists of the respective umpire names:::5:::', async () => {
    renderWithBrowserRouter(<App />, {route: '/team-matches/KKR'})
    const {latest_match_details} = recentMatchesResponse
  ...
  it(':::RJSCPNE8JJ_TEST_29:::When the Team Matches Route is opened and back is clicked in the browser, then the page should be navigated to the Home Route:::5:::', async () => {
