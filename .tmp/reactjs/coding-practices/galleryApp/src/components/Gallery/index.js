...
class Gallery extends Component {
  ...
  clickImg = unique => this.setState({id: unique})

  render() {
    const {image, id} = this.state
    const {imageUrl, imageAltText} = image[id]
    const className = 'listblur'

    console.log(image[id].imageAltText)
