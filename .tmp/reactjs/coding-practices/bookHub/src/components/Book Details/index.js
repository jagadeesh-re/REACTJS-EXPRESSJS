        ...
        <div className="book-details-container">
          <div className="book-details">
            <div className="book-container">
              <div className="book-detail-image-details ">
                <img src={coverPic} alt={title} className="detail-img" />
              </div>
              <div className="book-detail-image-details image-description">
                <div className="book-detail-info">
                  <h1 className="book-details-heading">{title}</h1>
                  <p className="book-detail-author-name">{authorName}</p>
                  <div className="book-detail-rating">
                    <p className="book-detail-rating-heading">Avg Rating</p>
                    <BsFillStarFill className="star" />
                    <p className="book-detail-rating-number">{rating}</p>
                  </div>
                  <div className="book-detail-status-container">
                    <p className="book-detail-status-paragraph">Status: </p>
                    <p className="book-detail-read-status">{readStatus}</p>
                  </div>
                </div>
              </div>
            </div>
