...
describe(':::RJSCPUAF4D_TEST_SUITE_1:::Cryptocurrency Tracker tests', () => {
  ...
  it(':::RJSCPUAF4D_TEST_3:::When the HTTP GET request is made to the apiUrl, then the page should consist of an HTML container element with testid attribute value as "loader":::5:::', async () => {
    render(<App />)
  ...
  it(':::RJSCPUAF4D_TEST_4:::When the HTTP GET request to the apiUrl is successful, then the HTML container element with testid attribute value as "loader" should be removed:::5:::', async () => {
    render(<App />)
